...
public class ControllerSceneMauvaisChoixFin  extends ControllerMaster implements Initializable {
    private AudioPlayer audioPlayer = new AudioPlayer(new File("src/Stages/Sons/mauvais.wav"));
